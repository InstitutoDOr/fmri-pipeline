...
% pres_codes
function model = get_sintaxe_model_simple()
...
model.name = 'COMPLETE_SIMPLE';
model.def  = def;

%% contrastes entre condicoes
contrasts = {
    {'Transitivo - Ligacao', [ 1  0 -1]}
    {'Transitivo - Controle', [ 1 0 0 -1]}
    {'Transitivo - Intransitivo', [ 1 -1]}
    {'Ligacao - Controle', [ 0 0 1 -1]}
    {'Intransitivo - Ligacao', [ 0 1 -1]}
    {'Intransitivo - Controle', [ 0 1 0 -1]}
    {'Estrutura argumental verbo', [3 1 -1 -3]}
    {'Estrutura argumental verbo micro', [1 0.5 -0.5 -1]}
    {'Estrutura argumental parametrizado', [1.5 1 0.5 -3]}
    {'Numero de referentes', [2 -1 2 -3]}
    {'Numero de referentes micro', [1 -0.5 1 -1.5]}
    {'Numero de palavras', [1 -1 1.5 -1.5]}
};
