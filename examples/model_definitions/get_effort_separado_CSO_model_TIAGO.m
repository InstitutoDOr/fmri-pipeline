...
% pres_codes
function model = get_effort_separado_CSO_model_TIAGO()
    ...
    model.name = 'EFFORT_SEP_CSO_TIAGO';
    model.def  = def;
    ...
    model.contrast(ci).name = 'CUE ONLY TEAM > CUE ONLY STI'; 
    
           ci= ci+1;
    
    model.contrast(ci).vec  = [ 0 0 0 0 0 0 -1 1];
    model.contrast(ci).name = 'CUE ONLY STI > CUE ONLY TEAM'; 
    
        ci= ci+1;
    
    model.contrast(ci).vec  = [ 0 0 0 0 0 0 -1 0 1 ];
    model.contrast(ci).name = 'CUE ONLY SELF > CUE ONLY TEAM';
    
            ci= ci+1;
    
    model.contrast(ci).vec  = [ 0 0 0 0 0 0 1 0 -1 ];
    model.contrast(ci).name = 'CUE ONLY TEAM > CUE ONLY SELF';
    
        ci= ci+1;
    
    model.contrast(ci).vec  = [ 0 0 0 0 0 0 0 -1 1 ];
    model.contrast(ci).name = 'CUE ONLY SELF > CUE ONLY STI';
    
    
        ci= ci+1;
    
    model.contrast(ci).vec  = [ 0 0 0 0 0 0 0 1 -1 ];
    model.contrast(ci).name = 'CUE ONLY STI > CUE ONLY SELF';
