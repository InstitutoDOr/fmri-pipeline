...
%(1) Directories:
curdir = pwd;
data_dir = '/dados1/PROJETOS/PRJ1410_FUTEBOL/03_PROCS/PROC_DATA/fMRI/NORM_ANAT/STATS/FIRST_LEVEL/RESP_MOV_CUE_SEP_MOTOR';
rois_dir = '/dados1/PROJETOS/PRJ1410_FUTEBOL/03_PROCS/ROIs/Functional Localizer';
%rois_dir = '/dados1/PROJETOS/PRJ1410_FUTEBOL/03_PROCS/ROIs/SBDM';
out_dir  = '/dados1/PROJETOS/PRJ1410_FUTEBOL/03_PROCS/ROIs/MARSBAR_TIMECOURSES/';
...
%roi_files = { 'SG_sphere_5mm_0_26_-5_roi'}
roi_files = { 'lAccumbens_10-12_10_-6_roi'}
...
for n = 1: n_roi
    ...
    out.fir_length = fir_length;
    
    if ~isdir(out_dir), mkdir(out_dir), end
    save( fullfile(out_dir, ['timecourses_PSC_' model_name '_' roi_files{n} '_' datestr(now, 'yyyymmdd_HHMM') '.mat']), 'out' );
