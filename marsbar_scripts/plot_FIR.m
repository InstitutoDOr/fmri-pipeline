...
load( fullfile(rdir, 'timecourses_PSC_STI_FPC_roi_20150724_1427'));

targets = { 'CUE SELF', 'CUE TEAM', 'CUE STI'};

targets = { 'CUE SELF', 'CUE TEAM', 'CUE STI', 'CUE EFFORT SELF', 'CUE EFFORT TEAM', 'CUE EFFORT STI'};
colors    = { 'k', 'b', 'r', 'k', 'b', 'r'};
linestyle = { '-', '-', '-', '--', '--', '--'};
