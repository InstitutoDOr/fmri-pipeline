...
if do_second_level
    ...
    %config.sec.covariate.vec  = [0 3 6 6 0 5 4 2 4 0 1 2 3 0 5 0 -1000 5 4 3 2 5 3 5 3 4 -1000 3 2 5 0 2];
    ...
    config.sec.covariate.vec = [2.75 1 0.25 0.25 2.25 5 1 3.75 3 1 -0.25 -1.25 2.25 2.5 4.75 1.5 -1000 3.75 3.25 2 1.25 2.75 3.25 6 3.25 6.25 -1000 -0.25 4.5 4.75 -1.5 0.5];
    ...
    %config.sec.covariate.vec  = [0.14 1.57 2.57 3.00 1.86 3.14 2.14 4.43 3.86 2.00 3.00 3.14 2.43 1.00 4.29 0.71 1000 4.14 1.29 1.14 0.00 3.43 3.00 3.71 4.43 3.00 1000 3.86 6.00 3.14 0.71 2.00]
    %config.sec.covariate.name = 'DIFF_FUSION';
    
    %config.sec.covariate.vec  = [3 1 1 3.333333333 5 5 3.666666667 4.666666667 6.333333333 5.333333333 2.666666667 5 2 1.666666667 3.333333333 2.333333333 -1000.00 2 4 1 1 4.666666667 3 4 2 4.666666667 -1000.00 4.666666667 7 4.333333333 2 4] 
    %config.sec.covariate.name = 'PSYCH_KIN';    
    ...
    config.sec.covariate.apply_contrasts = [1 3 7 10 13 16 18 25 28 31 34]; % apply covariates only for these contrasts (TEAM) CSO_MOTOR
    %config.sec.covariate.apply_contrasts = [2 5 8 11 14 17 21 26]; % apply covariates only for these contrasts (STI) CSO_MOTOR
    %config.sec.g1 = [2:16 18:26 28:32];
    config.sec.g1 = [2 4:16 18 19 21:26 28:32];
    %config.sec.g1 = [2:5 7:16 18:25 28:31];
    config.sec.g2 = [];
    config.sec.name = 'Believers_DiffETT';
