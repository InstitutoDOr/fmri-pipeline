...
matlabbatch{1}.spm.spatial.normalise.estwrite.eoptions.template = {'/usr/local/MATLAB/toolbox_IDOR/spm8/templates/EPI.nii,1'};
matlabbatch{1}.spm.spatial.normalise.estwrite.eoptions.weight = {'/usr/local/MATLAB/toolbox_IDOR/spm8/apriori/brainmask.nii,1'};
...
matlabbatch{1}.spm.spatial.normalise.estwrite.roptions.prefix = 'affinew';
