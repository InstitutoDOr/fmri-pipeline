...
%-----------------------------------------------------------------------
matlabbatch{1}.spm.stats.factorial_design.dir = {'/dados1/PROJETOS/PRJ1410_FUTEBOL/03_PROCS/PROC_DATA/fMRI/NORM_ANAT/STATS/SECOND_LEVEL/FLEX_FACTORIAL/'};
...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'MAIN EFFECT REWARD';
